...
window.RADAR_STORIES = [
  {
    ...
    summary:
      "Reports say OpenAI is considering a new private round, with outlets disagreeing on whether the mark is $1.2 trillion or $1.5 trillion.",
    ...
    grading:
      "One bar. No named source and no company statement. Four outlets carry it and they do not agree on the figure.",
    source: {
      name: "Bloomberg",
  ...
  },
  {
    ...
    summary:
      "Anthropic published how it rearchitected test impact analysis after continuous-integration jobs grew twenty-five-fold in six months.",
  ...
  },
  {
    ...
    summary:
      "OpenAI released the Agents API in public beta, exposing the managed harness that runs Codex to all developers.",
  ...
  },
  {
    ...
    summary:
      "Apple released Siri AI in beta on 14 September alongside iOS 27, running on-device and on Private Cloud Compute.",
  ...
  },
  {
    ...
    summary:
      "An Atria-Dawn-Preview repo and an OpenAI-compatible API appeared quietly, with gateway integration merged before the technical report was posted.",
    ...
    grading:
      "Two bars. The repository is real and verifiable. The claim that it preceded the report comes from secondary coverage, not from timestamps we read ourselves.",
  ...
  },
  {
    ...
    summary:
      "Cohere Labs published open weights for a 218B-parameter translation mixture-of-experts covering fifty languages, with twenty-five billion active parameters.",
  ...
  },
  {
    ...
    summary:
      "Shanghai AI Laboratory posted the Atria Dawn Preview technical report on arXiv, covering sixteen benchmarks and a human-AI collaboration study.",
  ...
  },
  {
    ...
    summary:
      "Dario Amodei argued the industry should slow capability gains by one to two years and committed Anthropic to embedded third-party evaluators.",
  ...
  },
  {
    ...
    summary:
      "Spokesperson Guo Jiakun called Amodei's chip-restriction argument fearmongering, days before US\u2013China talks in Washington.",
    ...
    grading:
      "Three bars. Reported independently by several outlets, but no primary transcript published.",
    source: {
      name: "NPR",
  ...
  },
  {
    ...
    summary:
      "Sakana AI released Fugu Max and Fugu Ultra v2, an orchestration layer that routes each request to the leanest model that can solve it.",
  ...
  },
  {
    ...
    summary:
      "404 Media obtained internal materials showing OpenAI hired hundreds of contractors to read, summarise and score real user conversations.",
    ...
    grading:
      "Two bars. One outlet with documents it has not published in full, and no company response yet.",
    source: {
      name: "404 Media",
  ...
  },
  {
    ...
    summary:
      "A permanent 25% weekly limit increase took effect on 14 September, one day after a temporary 50% boost expired.",
    ...
    grading:
      "Three bars. Several outlets did the arithmetic independently; there is no primary announcement framing it as a cut.",
    source: {
      name: "Implicator.ai",
  ...
  },
  {
    ...
    summary:
      "The Intel spinoff closed $205M led by IAG Capital Partners and launched a fabric that computes in-network alongside Qualcomm.",
  ...
  },
  {
    ...
    summary:
      "Perplexity shipped its fully local agent in the Windows app for RTX GPUs with 24GB or more of video memory.",
